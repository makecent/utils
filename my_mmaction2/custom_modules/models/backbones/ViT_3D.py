...
variants_cfg = dict(
    vit_small_patch16_224=dict(embed_dim=384, num_heads=6),
    vit_base_patch16_224=dict(),
    vit_base_patch16_384=dict(img_size=384),
    vit_large_patch16_224=dict(embed_dim=1024, depth=24, num_heads=16),
    vit_large_patch16_384=dict(img_size=384, embed_dim=1024, depth=24, num_heads=16),
    vit_large_patch16_512=dict(img_size=512, embed_dim=1024, depth=24, num_heads=16),
)
...
class VisionTransformer3D(nn.Module):
    ...
    def __init__(self,
        ...
        if variant is not None:
            assert variant in variants_cfg
            kwargs = variants_cfg.get(variant)
        ...
        # ---------- Below block is modified by Chongkai LU -------#
        if num_classes > 0:

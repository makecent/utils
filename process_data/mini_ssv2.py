...
train_sampled_list = []
val_sampled_list = []
for new_class_id, class_id in enumerate(most_87_classes):
    train_cate_list = train_list[train_list[2] == class_id]
    train_cate_list[2] = new_class_id
    train_sampled_list.append(train_cate_list.sample(600))

    val_cate_list = val_list[val_list[2] == class_id]
    val_cate_list[2] = new_class_id
...
final_train_list.to_csv("/home/louis/PycharmProjects/APN/my_data/sthv2/mini_sthv2_train_list_rawframes.txt", header=False, index=False, sep=' ')
final_val_list.to_csv("/home/louis/PycharmProjects/APN/my_data/sthv2/mini_sthv2_val_list_rawframes.txt", header=False, index=False, sep=' ')
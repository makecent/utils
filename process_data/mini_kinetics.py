...
train_sampled_list = []
val_sampled_list = []
for category in most_200_classes:
    train_cate_list = train_list[train_list[1] == category]
    train_sampled_list.append(train_cate_list.sample(400))

    val_cate_list = val_list[val_list[1] == category]
...
final_train_list.to_csv("/home/louis/PycharmProjects/ProgPreTrain/my_data/kinetics400/mini_kinetics200_train_list_videos.txt", header=False, index=False)
final_val_list.to_csv("/home/louis/PycharmProjects/ProgPreTrain/my_data/kinetics400/mini_kinetics200_val_list_videos.txt", header=False, index=False)
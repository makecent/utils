# This model is modified based on https:github.com/hassony2/kinetics_i3d_pytorch. Pretrained weights can also be found
# in that repository
import math
import os
import torch
...
class I3D(BaseModule):
    ...
    def forward(self, inp):
        ...
        ## We comment below layers of head because we only use i3d's backbone.
